...
class MainActivityTest : BaseUiTest() {
    ...
    @Test
    fun `activity launches and sets up fragments`() = launchActivity<MainActivity> { activity ->
    ...
    @Test
    fun `clicking profile image logs out user`() = launchActivity<MainActivity> { activity ->
    ...
    fun `username updates when user data received`() {
        ...
        launchActivity<MainActivity> { activity ->
    ...
    @Test
    fun `panel slide updates ui`() = launchActivity<MainActivity> { activity ->
