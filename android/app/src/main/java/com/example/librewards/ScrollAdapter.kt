...
class ScrollAdapter(var context : Context, var list: MutableList<Product>, var mOnProductListener: RecyclerAdapter.OnProductListener) : RecyclerView.Adapter<ScrollAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View, var onProductListener: RecyclerAdapter.OnProductListener) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
